...
insegment0=rltPath+"\\output\\tradition_centSize1.txt"
insegment1=rltPath+"\\output\\raytracing_centSize1.txt"
outsegment0=rltPath+"\\output\\tradition—a.vtp"
outsegment1=rltPath+"\\output\\raytracing—a.vtp"
...
outvoxcntFile=rltPath+"\\output\\voxelModel—a.vtp"
...
rayOutFile=rltPath+"\\output\\ray—a.vtp"
newdata=[]
